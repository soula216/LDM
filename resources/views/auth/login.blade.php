<x-guest-layout>
    <x-authentication-card>
        ...
        <form method="POST" action="{{ route('login') }}" class="login-form-new" novalidate>
            ...
            <div class="login-input-group login-animate-slide-up" style="--delay: 0.1s;">
                ...
                <button
                    ...
                    <svg id="eyeIcon" class="w-6 h-6 transition-opacity duration-200" fill="none" stroke="#00d4aa" stroke-width="3" viewBox="0 0 24 24">
                        <path stroke-linecap="round" stroke-linejoin="round" d="M15 12a3 3 0 11-6 0 3 3 0 016 0z"></path>
                        <path stroke-linecap="round" stroke-linejoin="round" d="M2.458 12C3.732 7.943 7.523 5 12 5c4.478 0 8.268 2.943 9.542 7-1.274 4.057-5.064 7-9.542 7-4.477 0-8.268-2.943-9.542-7z"></path>
                    </svg>
                    <svg id="eyeSlashIcon" class="w-6 h-6 transition-opacity duration-200 hidden" fill="none" stroke="#00d4aa" stroke-width="3" viewBox="0 0 24 24">
        ...
        <div class="login-register-cta login-register-cta--login">
            <p class="login-register-cta__label">Pas encore de compte ?</p>
            <a href="{{ route('register') }}" class="login-register-cta__link">Créer un compte dentiste</a>
        </div>
