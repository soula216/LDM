    ...
    * {
    ...
    .nav-dropdown__item--nested::after {
      content: '';
      position: absolute;
      top: 0;
      right: -0.7rem;
    ...
    .nav-dropdown__submenu-toggle i {
      font-size: 0.65rem;
      transition: transform 0.2s ease;
    }

    .nav-dropdown__item--nested:hover > .nav-dropdown__submenu-toggle,
    .nav-dropdown__item--nested.is-open > .nav-dropdown__submenu-toggle,
    .nav-dropdown__item--nested.is-active > .nav-dropdown__submenu-toggle {
      color: #0284c7;
      background: rgba(14, 165, 233, 0.1);
    }
    ...
    .nav-dropdown__item--nested:hover > .nav-dropdown--level-2,
    .nav-dropdown__item--nested:focus-within > .nav-dropdown--level-2,
    .nav-dropdown__item--nested.is-open > .nav-dropdown--level-2 {
      opacity: 1;
      visibility: visible;
      pointer-events: auto;
    ...
    .nav-dropdown__item--nested:hover > .nav-dropdown__submenu-toggle i,
    .nav-dropdown__item--nested.is-open > .nav-dropdown__submenu-toggle i {
    ...
    .nav-user-menu__toggle:focus-visible {
      outline: 2px solid rgba(14, 165, 233, 0.55);
      outline-offset: 2px;
    }

    .nav-user-menu__avatar-wrap {
      position: relative;
    ...
    .nav-espace-client-mobile .nav-user-menu__avatar-wrap {
      width: 2.25rem;
      height: 2.25rem;
    }
    ...
    .nav-user-menu__chevron i {
      font-size: 0.55rem;
      line-height: 1;
      transition: transform 0.2s ease;
    }

    .nav-user-menu.is-open .nav-user-menu__chevron i {
      transform: rotate(180deg);
    }
    ...
    .nav-user-menu.is-open .nav-user-menu__dropdown {
      opacity: 1;
      visibility: visible;
    ...
    .nav-user-menu__item:hover i,
    .nav-user-menu__item:focus-visible i {
    ...
    .nav-user-menu__item--danger:hover i,
    .nav-user-menu__item--danger:focus-visible i {
      color: #dc2626 !important;
    }

    .nav-user-menu__logout-form {
      margin: 0;
      width: 100%;
    }

    .nav-links .nav-user-menu__toggle::after,
    .nav-links .nav-user-menu a::after {
    ...
    .service-showcase__block.reveal.active {
      transition-delay: var(--showcase-delay, 0s);
    }

    .service-showcase__block:hover {
    ...
    .service-showcase__block--alt {
      background:
        linear-gradient(155deg, rgba(15, 23, 42, 0.97) 0%, rgba(15, 58, 92, 0.94) 52%, rgba(8, 47, 73, 0.98) 100%);
      border-color: rgba(56, 189, 248, 0.18);
    }

    .service-showcase__block-inner {
      position: relative;
      z-index: 2;
      display: grid;
    ...
    .service-showcase__block:not(.service-showcase__block--has-photos) .service-showcase__block-inner {
      grid-template-columns: 1fr;
    }

    .service-showcase__block--alt .service-showcase__block-inner {
      grid-template-columns: minmax(0, 1.15fr) minmax(0, 1fr);
    }

    .service-showcase__block--alt.service-showcase__block--has-photos .service-showcase__copy {
      grid-column: 2;
    }

    .service-showcase__block--alt.service-showcase__block--has-photos .service-showcase__mosaic {
      grid-column: 1;
      grid-row: 1;
    }

    .service-showcase__block--alt:not(.service-showcase__block--has-photos) .service-showcase__block-inner {
      grid-template-columns: 1fr;
    }
    ...
    .service-showcase__block--alt .service-showcase__index {
      background: rgba(125, 211, 252, 0.12);
      border-color: rgba(125, 211, 252, 0.22);
    }

    .service-showcase__block--alt .service-showcase__index span {
      color: #bae6fd;
    }
    ...
    .service-showcase__block--alt .service-showcase__title {
      color: #f8fafc;
    }
    ...
    .service-showcase__text--clamp::after {
      content: '';
      position: absolute;
      left: 0;
      right: 0;
    ...
    .service-showcase__block--alt .service-showcase__text--clamp::after {
      background: linear-gradient(180deg, rgba(15, 23, 42, 0) 0%, rgba(15, 58, 92, 0.96) 72%);
    }
    ...
    .service-showcase__text p:last-child {
      margin-bottom: 0;
    }

    .service-showcase__text.prose-vitrine h2,
    .service-showcase__text.prose-vitrine h3,
    .service-showcase__text.prose-vitrine h4 {
      margin-top: 1.1rem;
      margin-bottom: 0.55rem;
    }

    .service-showcase__text.prose-vitrine h2 { font-size: 1.2rem; }
    .service-showcase__text.prose-vitrine h3 { font-size: 1.08rem; }
    .service-showcase__text.prose-vitrine h4 { font-size: 1rem; }

    .service-showcase__text.prose-vitrine ul,
    .service-showcase__text.prose-vitrine ol {
      margin: 0 0 0.9rem 1.15rem;
    }

    .service-showcase__text.prose-vitrine img,
    .service-showcase__full-text.prose-vitrine img,
    .service-section-modal__content.prose-vitrine img {
      max-width: 100%;
      height: auto;
    ...
    .service-showcase__text.prose-vitrine table,
    .service-showcase__full-text.prose-vitrine table,
    .service-section-modal__content.prose-vitrine table {
      width: 100%;
    ...
    .service-showcase__text.prose-vitrine th,
    .service-showcase__text.prose-vitrine td,
    .service-showcase__full-text.prose-vitrine th,
    .service-showcase__full-text.prose-vitrine td,
    .service-section-modal__content.prose-vitrine th,
    .service-section-modal__content.prose-vitrine td {
      border: 1px solid rgba(148, 163, 184, 0.35);
      padding: 0.45rem 0.6rem;
      text-align: left;
    }

    .service-showcase__block--alt .service-showcase__text {
      color: rgba(226, 232, 240, 0.88);
    }

    .service-showcase__block--alt .service-showcase__text.prose-vitrine h2,
    .service-showcase__block--alt .service-showcase__text.prose-vitrine h3,
    .service-showcase__block--alt .service-showcase__text.prose-vitrine h4,
    .service-showcase__block--alt .service-showcase__text.prose-vitrine strong {
      color: #f8fafc;
    }

    .service-showcase__block--alt .service-showcase__text.prose-vitrine p,
    .service-showcase__block--alt .service-showcase__text.prose-vitrine ul,
    .service-showcase__block--alt .service-showcase__text.prose-vitrine ol,
    .service-showcase__block--alt .service-showcase__text.prose-vitrine li {
      color: rgba(226, 232, 240, 0.88);
    }

    .service-showcase__block--alt .service-showcase__text.prose-vitrine a {
      color: #7dd3fc;
    }

    .service-showcase__block--alt .service-showcase__text.prose-vitrine th,
    .service-showcase__block--alt .service-showcase__text.prose-vitrine td {
      border-color: rgba(148, 163, 184, 0.28);
    }

    .service-showcase__read-more {
      display: inline-flex;
      align-items: center;
      gap: 0.55rem;
      margin-top: 0.15rem;
    ...
    .service-showcase__read-more i {
      font-size: 0.72rem;
      transition: transform 0.28s ease;
    }

    .service-showcase__read-more:hover,
    .service-showcase__read-more:focus-visible {
    ...
    .service-showcase__read-more:hover i,
    .service-showcase__read-more:focus-visible i {
      transform: translateX(3px);
    }

    .service-showcase__block--alt .service-showcase__read-more {
      background: rgba(125, 211, 252, 0.1);
      border-color: rgba(125, 211, 252, 0.28);
      color: #bae6fd;
    }

    .service-showcase__block--alt .service-showcase__read-more:hover,
    .service-showcase__block--alt .service-showcase__read-more:focus-visible {
    ...
    body.service-section-modal-open {
      overflow: hidden;
    }

    body.service-section-modal-open .site-header {
      visibility: hidden;
      opacity: 0;
      pointer-events: none;
    }
    ...
    .service-section-modal.is-active {
      opacity: 1;
      pointer-events: auto;
    }

    .service-section-modal[hidden] {
      display: none !important;
    }

    .service-section-modal__backdrop {
      position: absolute;
      inset: 0;
      background:
        radial-gradient(circle at 20% 10%, rgba(56, 189, 248, 0.18) 0%, transparent 42%),
    ...
    .service-section-modal__shell {
      ...
      border-radius: 28px;
      background:
        linear-gradient(160deg, rgba(255, 255, 255, 0.98) 0%, rgba(241, 245, 249, 0.96) 100%);
      border: 1px solid rgba(186, 230, 253, 0.45);
      box-shadow:
        0 40px 90px rgba(2, 18, 32, 0.42),
    ...
    .service-section-modal.is-active .service-section-modal__shell {
      transform: translateY(0) scale(1);
    }

    .service-section-modal__header {
      display: flex;
      align-items: center;
      justify-content: space-between;
      gap: 1rem;
      ...
      background: linear-gradient(180deg, rgba(224, 242, 254, 0.55) 0%, rgba(255, 255, 255, 0) 100%);
    }

    .service-section-modal__meta {
      display: flex;
      align-items: center;
      gap: 0.65rem;
      min-width: 0;
    ...
    .service-section-modal__index:empty,
    .service-section-modal__index[hidden] {
      display: none;
    }

    .service-section-modal__close {
      display: inline-flex;
      align-items: center;
      justify-content: center;
      width: 2.6rem;
    ...
    .service-section-modal__close:hover,
    .service-section-modal__close:focus-visible {
      background: #0c4a6e;
      border-color: #0c4a6e;
      color: #fff;
    ...
    .service-section-modal__body {
      padding: 0.35rem 1.35rem 1.6rem;
      overflow-y: auto;
      overscroll-behavior: contain;
    }

    .service-section-modal__title {
      margin: 0 0 1.1rem;
      font-family: 'Space Grotesk', sans-serif;
    ...
    .service-section-modal__content {
      color: #475569;
      font-size: 1.02rem;
      line-height: 1.8;
    }

    .service-section-modal__content p {
      margin: 0 0 1rem;
    }

    .service-section-modal__content p:last-child {
      margin-bottom: 0;
    }
    ...
    .service-showcase__mosaic--1 {
      grid-template-columns: 1fr;
    }

    .service-showcase__mosaic--2 {
      grid-template-columns: repeat(2, minmax(0, 1fr));
    }

    .service-showcase__mosaic--bento {
      grid-template-columns: repeat(6, minmax(0, 1fr));
      grid-auto-rows: 108px;
    }

    .service-showcase__mosaic--bento .service-showcase__tile:first-child {
      grid-column: span 3;
      grid-row: span 2;
    }

    .service-showcase__mosaic--bento .service-showcase__tile:nth-child(2),
    .service-showcase__mosaic--bento .service-showcase__tile:nth-child(3) {
      grid-column: span 3;
    }

    .service-showcase__mosaic--bento .service-showcase__tile:nth-child(n+4) {
      grid-column: span 2;
    }

    .service-showcase__tile {
      display: flex;
      flex-direction: column;
      gap: 0.55rem;
      width: 100%;
    ...
    .service-showcase__tile:focus-visible {
      outline: none;
    }

    .service-showcase__tile:focus-visible .service-showcase__tile-visual {
      outline: 3px solid rgba(56, 189, 248, 0.55);
      outline-offset: 3px;
    }

    .service-showcase__tile-visual {
      position: relative;
      width: 100%;
      height: 100%;
      min-height: 140px;
    ...
    .service-showcase__tile:hover .service-showcase__tile-visual,
    .service-showcase__tile:focus-visible .service-showcase__tile-visual {
    ...
    .service-showcase__tile-visual img {
      width: 100%;
      height: 100%;
      object-fit: cover;
      display: block;
    ...
    .service-showcase__tile:hover .service-showcase__tile-visual img,
    .service-showcase__tile:focus-visible .service-showcase__tile-visual img {
      transform: scale(1.07);
    }

    .service-showcase__tile-overlay {
      position: absolute;
      inset: 0;
      display: flex;
      align-items: center;
    ...
    .service-showcase__tile:hover .service-showcase__tile-overlay,
    .service-showcase__tile:focus-visible .service-showcase__tile-overlay {
      opacity: 1;
    }

    .service-showcase__tile-expand {
      display: inline-flex;
      align-items: center;
      justify-content: center;
      width: 3rem;
    ...
    .service-showcase__tile:hover .service-showcase__tile-expand,
    .service-showcase__tile:focus-visible .service-showcase__tile-expand {
      transform: scale(1);
    }

    .service-showcase__tile-caption {
      font-size: 0.8rem;
      font-weight: 600;
      color: var(--text-muted);
      line-height: 1.35;
    ...
    .service-showcase__block--alt .service-showcase__tile-caption {
    ...
    .service-showcase__block--alt .service-showcase__glow {
    ...
    .gallery-category-filter strong {
      display: inline-flex;
      align-items: center;
      justify-content: center;
      min-width: 25px;
    ...
    .gallery-category-filter.is-active {
      color: #fff;
      background: linear-gradient(135deg, #0ea5e9 0%, #2563eb 100%);
      box-shadow: 0 8px 20px rgba(14, 165, 233, 0.24);
    }

    .gallery-category-filter.is-active strong {
      color: #fff;
    ...
    .gallery-page .gallery-tile__category {
      display: block;
    ...
    .about-overview-tab::after {
      display: none !important;
    }

    .about-overview-tab:hover {
      color: #0284c7;
      background: rgba(14, 165, 233, 0.08);
      transform: translateY(-1px);
    }

    .about-overview-tab.is-active {
      color: #fff;
      background: linear-gradient(135deg, #0ea5e9 0%, #2563eb 100%);
      box-shadow: 0 10px 24px rgba(14, 165, 233, 0.28);
    }

    .about-overview-tab__index {
      display: inline-flex;
      align-items: center;
      justify-content: center;
      width: 28px;
    ...
    .about-overview-tab.is-active .about-overview-tab__index {
      color: #fff;
      background: rgba(255, 255, 255, 0.2);
    }
    ...
    .about-sections__head {
      text-align: center;
      max-width: 680px;
      margin: 0 auto 2.75rem;
    }

    .about-sections__kicker {
      display: inline-flex;
      align-items: center;
      gap: 0.55rem;
    ...
    .about-sections__track {
      display: grid;
      gap: 1.15rem;
      position: relative;
    }

    .about-sections__track::before {
      content: '';
      position: absolute;
      left: 2.15rem;
      top: 1.5rem;
      bottom: 1.5rem;
      width: 2px;
      background: linear-gradient(180deg, rgba(14, 165, 233, 0.45), rgba(16, 185, 129, 0.35), rgba(14, 165, 233, 0.2));
      border-radius: 999px;
      pointer-events: none;
    }

    .about-sections__item {
      position: relative;
      display: grid;
      ...
      border-radius: 22px;
      background:
        radial-gradient(circle at 100% 0%, rgba(14, 165, 233, 0.08) 0%, transparent 42%),
    ...
    .about-sections__item--alt {
      background:
        radial-gradient(circle at 0% 100%, rgba(16, 185, 129, 0.12) 0%, transparent 45%),
        linear-gradient(145deg, #0f172a 0%, #1e293b 58%, #0f172a 100%);
    ...
    .about-sections__item--alt:hover {
    ...
    .about-sections__item--alt .about-sections__index {
      background: linear-gradient(135deg, rgba(16, 185, 129, 0.18), rgba(14, 165, 233, 0.12));
      border-color: rgba(110, 231, 183, 0.28);
      box-shadow: inset 0 1px 0 rgba(255, 255, 255, 0.08);
    }

    .about-sections__item--alt .about-sections__index span {
      color: #6ee7b7;
    }

    .about-sections__body {
      position: relative;
      z-index: 1;
      min-width: 0;
      padding-top: 0.2rem;
    ...
    .about-sections__item--alt .about-sections__title {
      color: #f8fafc;
    }

    .about-sections__content p {
      margin: 0 0 0.95rem;
    ...
    .about-sections__content p:last-child {
      margin-bottom: 0;
    }

    .about-sections__item--alt .about-sections__content p {
      color: rgba(226, 232, 240, 0.88);
    }

    .about-sections__glow {
      position: absolute;
      right: -3rem;
      top: -3rem;
      width: 9rem;
    ...
    .about-sections__item--alt .about-sections__glow {
      background: radial-gradient(circle, rgba(16, 185, 129, 0.16) 0%, transparent 70%);
    }

    .about-sections .reveal {
      transition-delay: var(--about-section-delay, 0s);
    }
    ...
    @@media (max-width: 1100px) {
      ...
      nav.mobile-menu-open .nav-dropdown__item--nested {
        display: flex;
        flex-direction: column;
        align-items: flex-end;
        width: 100%;
      ...
      nav.mobile-menu-open .nav-dropdown__submenu-toggle {
        width: auto;
        padding: 0.45rem 0;
        color: #cbd5e1;
        font-size: 0.95rem;
      ...
      nav.mobile-menu-open .nav-dropdown__submenu-toggle i {
        margin-left: 0.4rem;
      }

      nav.mobile-menu-open .nav-dropdown--level-2 {
        position: static;
        width: 100%;
        max-width: 250px;
        margin: 0;
      ...
      nav.mobile-menu-open .nav-dropdown__item--nested.is-open > .nav-dropdown--level-2 {
        display: block;
      }

      nav.mobile-menu-open .nav-dropdown--level-2 a {
    ...
    @@media (max-width: 768px) {
      ...
      .service-section-modal__body {
        padding: 0.15rem 1.05rem 1.25rem;
      }
