...
>
    ...
    <nav class="flex-1 overflow-y-auto sidebar-scroll px-3 pb-4 space-y-6">
        ...
        @canany(['manage_config', 'manage_vitrine', 'view_roles', 'manage_permissions'])
        <div>
            ...
            <div class="space-y-1">
                ...
                @can('manage_vitrine')
                <x-sidebar-link href="{{ route('admin.vitrine.index') }}" :active="request()->routeIs('admin.vitrine.*')" @click="sidebarOpen = false">
        ...
        @if(auth()->user()?->hasRole('admin'))
        <div>
            <p class="sidebar-section-title">Messages contact</p>
            <div class="space-y-1">
                <x-sidebar-link href="{{ route('admin.contact-messages.index') }}" :active="request()->routeIs('admin.contact-messages.*')" @click="sidebarOpen = false">
                    <svg class="sidebar-icon" width="20" height="20" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M3 8l7.89 5.26a2 2 0 002.22 0L21 8M5 19h14a2 2 0 002-2V7a2 2 0 00-2-2H5a2 2 0 00-2 2v10a2 2 0 002 2z"></path></svg>
                    <span>{{ __('Messages contact') }}</span>
                </x-sidebar-link>
            </div>
        </div>
        <div>
            <p class="sidebar-section-title">Candidatures</p>
            <div class="space-y-1">
                <x-sidebar-link href="{{ route('admin.job-applications.index') }}" :active="request()->routeIs('admin.job-applications.*')" @click="sidebarOpen = false">
                    <svg class="sidebar-icon" width="20" height="20" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M21 13.255A23.931 23.931 0 0112 15c-3.183 0-6.22-.62-9-1.745M16 6V4a2 2 0 00-2-2h-4a2 2 0 00-2 2v2m4 6h.01M5 20h14a2 2 0 002-2V8a2 2 0 00-2-2H5a2 2 0 00-2 2v10a2 2 0 002 2z"></path></svg>
                    <span>{{ __('Candidatures d\'offres d\'emploi') }}</span>
                </x-sidebar-link>
            </div>
        </div>
        @endif
