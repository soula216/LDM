                ...
                <form action="{{ route('admin.users.update', $user) }}" method="POST" class="space-y-6">
                    ...
                    <div class="grid grid-cols-1 sm:grid-cols-2 gap-4 sm:gap-6">
                        ...
                        <div>
                            ...
                            <select name="role" id="role" class="block w-full input-field">
                        ...
                        <div>
                            ...
                            <x-input id="num_ordinaire" name="num_ordinaire" type="text" class="block w-full input-field" value="{{ $user->num_ordinaire }}" />
