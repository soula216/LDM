<x-app-layout>
    ...
    <div class="py-4 sm:py-8 bg-app min-h-screen" x-data="{ showGroupe: false }">
                ...
                <form action="{{ route('admin.teams.store') }}" method="POST" class="space-y-6">
                    ...
                    <div class="grid grid-cols-1 sm:grid-cols-2 gap-4 sm:gap-6">
                        ...
                        <div>
                            ...
                            <select id="role" name="role" class="block w-full input-field" required x-on:change="showGroupe = $event.target.value === 'employer'">
