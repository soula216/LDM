...
<x-app-layout>
    ...
    <div class="py-4 sm:py-8 bg-app min-h-screen">
        <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
                ...
                <form action="{{ route('admin.commandes.store') }}" method="POST" class="space-y-6">
                    ...
                    <div class="grid grid-cols-1 sm:grid-cols-2 gap-4 sm:gap-6">
                        ...
                        <div>
                            ...
                            <x-input id="num_cmd" name="num_cmd" type="text" class="block w-full input-field" />
                        ...
                        <div class="tache-item card border-l-4 border-primary relative overflow-hidden">
                            ...
                            <div class="flex flex-row gap-4 items-end">
                                <div class="flex-1 min-w-0">
                                    ...
                                    <select name="taches[0][service_id]" id="taches[0][service_id]" class="block w-full input-field tache-service-select" required>
            ...
            <!-- Fichiers -->
            <div class="card mt-6" x-data="{ showImageModal: false, imageUrl: '', imageName: '', empreinteError: '' }" x-cloak>
                <div class="p-4 sm:p-6">
                    <h3 class="text-lg font-semibold text-primary mb-4">Fichiers</h3>
                    <p class="text-sm text-secondary mb-4">Vous pourrez uploader les fichiers après la création de la commande.</p>
                    @can('upload_commande_files')
                    <div class="grid grid-cols-1 sm:grid-cols-2 gap-4 mb-6">
                        <!-- Formulaire Empreinte -->
                        <form class="border border-border rounded-lg p-4 opacity-60" onsubmit="return false;">
                            @csrf
                            ...
                            <div class="mb-3">
                                ...
                                <input type="file" disabled class="block w-full text-sm text-secondary file:mr-4 file:py-2 file:px-4 file:rounded-lg file:border-0 file:text-sm file:font-semibold file:bg-primary/10 file:text-primary hover:file:bg-primary/20">
                            ...
                            <button type="button" disabled class="btn-primary w-full opacity-50 cursor-not-allowed">Uploader</button>
                        </form>
                        <!-- Formulaire Image -->
                        <form class="border border-border rounded-lg p-4 opacity-60" onsubmit="return false;">
                            @csrf
